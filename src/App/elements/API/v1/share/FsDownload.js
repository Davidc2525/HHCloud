...
class FsDownloadOperation {
	constructor({
		spath = "/", // string or Immutable.List
		subpath="",
		owner = null,
		thenCB = _ => {},
		catchCB = _ => {},
		...
		this.xhr.open('POST', ApiInstance.instance.urlService+"share?op=fs::download&save=true" /*+ `?args=${btoa(JSON.stringify(args))}`*/, true);
...
export default FsDownloadOperation;